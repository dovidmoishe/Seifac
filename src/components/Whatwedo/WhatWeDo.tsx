...
const services = [
  {
    ...
    description:
      "Precision agriculture, digital farm tools, and input financing for modern farms.",
    icon: "🌾",
    subServices: [
      "Farm ERP",
    ...
    image:
      "https://images.unsplash.com/photo-1625246333195-78d73c5207fd?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Certified medical equipment, diagnostics, and lab supplies for institutions.",
    icon: "🏥",
    image:
  ...
  },
  {
    ...
    description:
      "Tech devices for offices, learning, and retail—from laptops to networking tools.",
    icon: "💻",
    image:
  ...
  },
  {
    ...
    description:
      "Premium wine imports for events, collectors, and hospitality businesses.",
    icon: "🍷",
    image:
  ...
  },
  {
    ...
    description:
      "Imported sanitary wares, floor and wall tiles designed for elegance.",
    icon: "🚿",
    image:
  ...
  },
  {
    ...
    description:
      "FDA-certified disposable cups, cutlery, containers, and lab ware.",
    icon: "♻️",
    image:
      "https://images.unsplash.com/photo-1576009603568-78f904f2b253?q=80&w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    description:
      "Luxury virgin hair products sourced from India and Southeast Asia.",
    icon: "💇‍♀️",
    image:
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Seifac is primarily an agricultural innovation leader, specializing in Farm ERP, 
            Extension Advisory, and Farm Management. We also deliver solutions across healthcare,
            technology, and lifestyle sectors to support diverse needs nationwide.
          </p>
        </motion.div>
            ...
            <div className="flex flex-col md:flex-row gap-6 items-center">
              ...
              <div className="md:w-3/4">
                ...
                <p className="text-gray-700 mb-2">
                  ✓ Agricultural innovation leaders with advanced Farm ERP solutions and farm management expertise.
                </p>
                <p className="text-gray-700 mb-2">
                  ✓ Trusted international sourcing & transparent pricing across all sectors.
                </p>
                <p className="text-gray-700 mb-2">
                  ✓ Nationwide delivery and after-sales support.
                </p>
                <p className="text-gray-700">
                  ✓ Commitment to agricultural advancement, quality, innovation, and long-term
                  partnerships.
                </p>
              </div>
            </div>
